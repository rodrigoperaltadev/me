      ...
      <div className="max-w-4xl mx-auto px-4 py-16 md:py-32 space-y-16">
        ...
        <article className="relative">
          ...
          <TerminalWindow className="relative mb-16">
            <div className="prose prose-invert prose-lg max-w-none lg:px-4 prose-headings:font-heading prose-headings:uppercase prose-headings:tracking-tighter prose-headings:text-text-primary prose-h1:text-4xl prose-h1:border-l-4 prose-h1:border-accent prose-h1:pl-6 prose-h2:text-3xl prose-h2:text-text-primary/90 prose-p:font-mono prose-p:text-[15px] prose-p:tracking-wide prose-p:text-text-primary/90 prose-p:leading-relaxed prose-strong:text-accent prose-strong:font-bold prose-a:text-accent prose-a:no-underline hover:prose-a:underline prose-li:text-text-primary/90 prose-li:font-mono prose-blockquote:border-l-4 prose-blockquote:border-accent prose-blockquote:text-text-primary/90 prose-blockquote:italic prose-code:text-accent prose-code:bg-black/30 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-pre:bg-black/50 prose-pre:border prose-pre:border-white/10 prose-hr:border-white/20 prose-ul:list-disc prose-ol:list-decimal prose-ul:pl-6 prose-ol:pl-6">
