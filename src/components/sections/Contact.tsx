...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-32 px-6 bg-background border-t border-white/5 relative overflow-x-clip">
      ...
      <div className="max-w-3xl mx-auto reveal">
        <div className="bg-surface p-10 md:p-16 brutalist-border-thick rounded-xs relative">
          <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-3">
                ...
                <input
                  ...
                  className="w-full bg-black border border-white/10 rounded-none px-5 py-4 text-white focus:outline-hidden focus:border-accent transition-colors font-mono text-sm placeholder:text-white/30"
                />
              </div>
              <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                className="w-full bg-black border border-white/10 rounded-none px-5 py-4 text-white focus:outline-hidden focus:border-accent transition-colors font-mono text-sm placeholder:text-white/30 resize-none"
              />
            </div>
          ...
          <div className="mt-12 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex gap-6">
              ...
              <a href="mailto:rodrigo.peralta@dev" className="text-text-secondary hover:text-accent transition-colors">
